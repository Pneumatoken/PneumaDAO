...
* Why is Pneuma crypto ecosystem neccesary 
* Why we need Pneuma token economics 
* Concequences of removing Pneuma Coin 
##### user stories:
    * students 
    * online Mentors 
    etc
...
* do last
* integrated uport self sovereign identity system
* neo4j - rural venture ecosystem graph database
* student transcript of indepdent personality, Achievement and IQ testing
...
### What is next for the project? see road-map
